...
const Mac = () => {
  ...
  const heroProducts = products.find((p) => p.category_id.slug == "mac");
  return (
    <Container extraClass="px-6 md:px-16 my-10">
          ...
          <>
            <div className="text-left text-white z-10 max-w-lg">
              ...
              <p className="mt-4 text-lg">
                Experience the cutting-edge technology with the new Mac. A leap
                in performance, design, and capability.
              </p>
            </div>
            <img
      ...
      <div className="flex flex-wrap justify-center gap-8 xl:gap-16">
        {products
          .filter((p) => p.category_id.slug === "mac")
          .map((iphone, index) => (
