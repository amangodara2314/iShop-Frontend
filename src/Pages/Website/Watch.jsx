...
const Iphone = () => {
  ...
  const heroProducts = products.find(
    (p) => p.category_id.slug == "apple-watch"
  );
  return (
    <Container extraClass="px-6 md:px-16 my-10">
          ...
          <>
            <div className="text-left text-white z-10 max-w-lg">
              ...
              <p className="mt-4 text-lg">
                Elevate your lifestyle with the new Watch. A blend of elegance
                and technology.
              </p>
            </div>
            <img
      ...
      <div className="flex flex-wrap justify-center gap-8 xl:gap-16">
        {products
          .filter((p) => p.category_id.slug === "apple-watch")
          .map((iphone, index) => (
